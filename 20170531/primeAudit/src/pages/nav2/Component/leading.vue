	        ...
	        <div class="modal-dialog">
	            <div class="modal-content">
	                <div class="modal-header">
	                    ...
	                    <h4 class="modal-title" id="myModalLabel">项目管理 > 已激活 > 新增 > 现场负责人选择</h4>
	                </div>
...
import qs from 'qs'
	export default{
		...
		methods:{
	    	...
	    	chooseList(leadingId,leadingName) {
	    		this.leadingId = leadingId
	    		this.leadingName = leadingName
	    	},
	    	confirm() {
	    		console.log(this.leadingName)
	    		console.log(this.leadingId)
	    		this.$emit("leadingName",this.leadingName)
	    		this.$emit("leadingId",this.leadingId)
	    		this.$emit('close')
	    	}
		},
		beforeMount() {
