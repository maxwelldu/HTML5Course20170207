	        ...
	        <div class="modal-dialog">
	            <div class="modal-content">
	                <div class="modal-header">
	                    ...
	                    <h4 class="modal-title" id="myModalLabel">项目管理 > 已激活 > 新增 > 项目合伙人选择</h4>
	                </div>
	                  	...
	                  	<div style="height:100%">
		                	<table id="customerTable" cellspacing="0" width="100%" class="table table-striped" >
		                        ...
		                        <tbody class="cutTaBody">
		                          <template v-for="(item,key) in partnerList">
...
import qs from 'qs'
	export default{
		...
		methods:{
	    	...
	    	chooseList(partnerId,partnerName) {
	    		this.partnerId = partnerId
	    		this.partnerName = partnerName
	    	},
	    	confirm() {
	    		this.$emit('partnerId',this.partnerId)
	    		this.$emit('partnerName',this.partnerName)
	    		this.$emit('close')
	    	}
		},
		beforeMount() {
		    ...
		    .then(function (response) {
		    	self.partnerList = JSON.parse(response.data.data)
		    	self.partnerList = self.partnerList.Data
		    })
